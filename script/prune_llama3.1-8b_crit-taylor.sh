...
export OUTPUT_SENSITIVITY=/home/ubuntu/shortened-llm/output_block_sensitivity/$MODEL_NAME/taylor_n${NUM_CALIB_DATA}
export OUTPUT_PRUNE=/ephemeral/output_prune/$MODEL_NAME/taylor_n${NUM_CALIB_DATA}/rm_${NUM_PRUNED_BLOCKS}_blocks
export OUTPUT_TUNE=/home/ubuntu/shortened-llm/output_tune/$MODEL_NAME/taylor_n${NUM_CALIB_DATA}/rm_${NUM_PRUNED_BLOCKS}_blocks
